...
export class Migration1712879213036 implements MigrationInterface {
    name = 'Migration1712879213036'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "entertainment_schedule" ("duration" integer, "start" datetime NOT NULL, "isCanceled" boolean NOT NULL DEFAULT (false), "id" integer PRIMARY KEY NOT NULL, "entertainementId" integer)`);
        ...
        await queryRunner.query(`CREATE TABLE "open_day" ("id" integer PRIMARY KEY NOT NULL, "dayStart" datetime NOT NULL, "dayEnd" datetime NOT NULL, "eventId" integer)`);
        await queryRunner.query(`CREATE TABLE "price" ("id" integer PRIMARY KEY NOT NULL, "priceCondition" varchar, "paymentableId" integer)`);
        ...
        await queryRunner.query(`CREATE TABLE "transit" ("id" integer PRIMARY KEY NOT NULL, "name" varchar(255) NOT NULL, "address" varchar(255) NOT NULL, "availableSeats" integer NOT NULL, "start" datetime NOT NULL, "arrival" datetime NOT NULL, "eventId" integer)`);
        ...
        await queryRunner.query(`CREATE TABLE "rpg_table" ("duration" integer, "start" datetime NOT NULL, "isCanceled" boolean NOT NULL DEFAULT (false), "id" integer PRIMARY KEY NOT NULL, "rpgActivityId" integer)`);
        ...
        await queryRunner.query(`CREATE TABLE "rpg_activity" ("name" varchar(255) NOT NULL, "description" text NOT NULL, "maxNumberSeats" integer, "duration" integer, "onReservation" boolean NOT NULL DEFAULT (0), "isCanceled" boolean NOT NULL DEFAULT (0), "id" integer PRIMARY KEY NOT NULL, "rpgZoneId" integer, "rpgId" integer)`);
        await queryRunner.query(`CREATE TABLE "rpg_zone" ("name" varchar(255) NOT NULL, "id" integer PRIMARY KEY NOT NULL)`);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_entertainment_schedule" ("duration" integer, "start" datetime NOT NULL, "isCanceled" boolean NOT NULL DEFAULT (false), "id" integer PRIMARY KEY NOT NULL, "entertainementId" integer, CONSTRAINT "FK_cf1e51526e46dfb550fa89013ef" FOREIGN KEY ("entertainementId") REFERENCES "entertainment" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`);
        await queryRunner.query(`INSERT INTO "temporary_entertainment_schedule"("duration", "start", "isCanceled", "id", "entertainementId") SELECT "duration", "start", "isCanceled", "id", "entertainementId" FROM "entertainment_schedule"`);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_open_day" ("id" integer PRIMARY KEY NOT NULL, "dayStart" datetime NOT NULL, "dayEnd" datetime NOT NULL, "eventId" integer, CONSTRAINT "FK_d6cb130c1d5e32f87d4d0c455a0" FOREIGN KEY ("eventId") REFERENCES "event" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_price" ("id" integer PRIMARY KEY NOT NULL, "priceCondition" varchar, "paymentableId" integer, CONSTRAINT "FK_1f19321dff24b1dd3410f0a7fce" FOREIGN KEY ("paymentableId") REFERENCES "paymentable" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`);
        await queryRunner.query(`INSERT INTO "temporary_price"("id", "priceCondition", "paymentableId") SELECT "id", "priceCondition", "paymentableId" FROM "price"`);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_transit" ("id" integer PRIMARY KEY NOT NULL, "name" varchar(255) NOT NULL, "address" varchar(255) NOT NULL, "availableSeats" integer NOT NULL, "start" datetime NOT NULL, "arrival" datetime NOT NULL, "eventId" integer, CONSTRAINT "FK_683856451bad1d3f8263e0ee058" FOREIGN KEY ("eventId") REFERENCES "event" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_rpg_table" ("duration" integer, "start" datetime NOT NULL, "isCanceled" boolean NOT NULL DEFAULT (false), "id" integer PRIMARY KEY NOT NULL, "rpgActivityId" integer, CONSTRAINT "FK_4db42ff5be39dc5f967558ff607" FOREIGN KEY ("rpgActivityId") REFERENCES "rpg_activity" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`);
        await queryRunner.query(`INSERT INTO "temporary_rpg_table"("duration", "start", "isCanceled", "id", "rpgActivityId") SELECT "duration", "start", "isCanceled", "id", "rpgActivityId" FROM "rpg_table"`);
        await queryRunner.query(`DROP TABLE "rpg_table"`);
        await queryRunner.query(`ALTER TABLE "temporary_rpg_table" RENAME TO "rpg_table"`);
        await queryRunner.query(`CREATE TABLE "temporary_rpg_activity" ("name" varchar(255) NOT NULL, "description" text NOT NULL, "maxNumberSeats" integer, "duration" integer, "onReservation" boolean NOT NULL DEFAULT (0), "isCanceled" boolean NOT NULL DEFAULT (0), "id" integer PRIMARY KEY NOT NULL, "rpgZoneId" integer, "rpgId" integer, CONSTRAINT "FK_43adbbebefa529117f767d07593" FOREIGN KEY ("rpgZoneId") REFERENCES "rpg_zone" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION, CONSTRAINT "FK_9c9700f32a962570a32b350bfb6" FOREIGN KEY ("rpgId") REFERENCES "rpg" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`);
        await queryRunner.query(`INSERT INTO "temporary_rpg_activity"("name", "description", "maxNumberSeats", "duration", "onReservation", "isCanceled", "id", "rpgZoneId", "rpgId") SELECT "name", "description", "maxNumberSeats", "duration", "onReservation", "isCanceled", "id", "rpgZoneId", "rpgId" FROM "rpg_activity"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "rpg_activity" ("name" varchar(255) NOT NULL, "description" text NOT NULL, "maxNumberSeats" integer, "duration" integer, "onReservation" boolean NOT NULL DEFAULT (0), "isCanceled" boolean NOT NULL DEFAULT (0), "id" integer PRIMARY KEY NOT NULL, "rpgZoneId" integer, "rpgId" integer)`);
        await queryRunner.query(`INSERT INTO "rpg_activity"("name", "description", "maxNumberSeats", "duration", "onReservation", "isCanceled", "id", "rpgZoneId", "rpgId") SELECT "name", "description", "maxNumberSeats", "duration", "onReservation", "isCanceled", "id", "rpgZoneId", "rpgId" FROM "temporary_rpg_activity"`);
        ...
        await queryRunner.query(`CREATE TABLE "rpg_table" ("duration" integer, "start" datetime NOT NULL, "isCanceled" boolean NOT NULL DEFAULT (false), "id" integer PRIMARY KEY NOT NULL, "rpgActivityId" integer)`);
        await queryRunner.query(`INSERT INTO "rpg_table"("duration", "start", "isCanceled", "id", "rpgActivityId") SELECT "duration", "start", "isCanceled", "id", "rpgActivityId" FROM "temporary_rpg_table"`);
        ...
        await queryRunner.query(`CREATE TABLE "price" ("id" integer PRIMARY KEY NOT NULL, "priceCondition" varchar, "paymentableId" integer)`);
        await queryRunner.query(`INSERT INTO "price"("id", "priceCondition", "paymentableId") SELECT "id", "priceCondition", "paymentableId" FROM "temporary_price"`);
        ...
        await queryRunner.query(`CREATE TABLE "entertainment_schedule" ("duration" integer, "start" datetime NOT NULL, "isCanceled" boolean NOT NULL DEFAULT (false), "id" integer PRIMARY KEY NOT NULL, "entertainementId" integer)`);
        await queryRunner.query(`INSERT INTO "entertainment_schedule"("duration", "start", "isCanceled", "id", "entertainementId") SELECT "duration", "start", "isCanceled", "id", "entertainementId" FROM "temporary_entertainment_schedule"`);
