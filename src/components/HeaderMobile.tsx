...
const HeaderMobile: FC<{ scan: () => Promise<void> }> = ({ scan }) => {
  return (
    <IonHeader color="base" className="bg-base middle h-fit relative">
      <img src="src/assets/img/ornament.png" className="absolute w-1/3 left-1 top-1" alt="" />
      <img src="src/assets/img/ornament-mirror.png" className="absolute w-1/3 right-1 top-1" alt="" />
      <div className="bg-base flex justify-between items-end w-full px-5 py-2 mb-0">
